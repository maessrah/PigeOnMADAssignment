...
public class AddImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        saveImage=(Button) view.findViewById(R.id.uploadProofBtn);
        proofImg=(ImageView) view.findViewById(R.id.proofImage);
        return view;
    }
    ...
    private void init(){
        proofImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               //startActivityForResult(intent, CameraCaptureSession);
            }
        });
    }
}